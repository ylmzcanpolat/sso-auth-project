...
INSERT INTO `Users` VALUES (468,'test_admin','test_admin','test_admin','test_admin@gmail.com','test_admin','Admin'),(485,'user1','user1_name','user1_surname','user1@mail.com','5484dad5d167ec4c15f730c81e3263bd2c0e4c55e8a34f65f5dea583b066d524','User'),(486,'admin','admin_name','admin_surname','admin@mail.com','5484dad5d167ec4c15f730c81e3263bd2c0e4c55e8a34f65f5dea583b066d524','Admin');
...
BEGIN
    SELECT id, username, user_name, user_surname, user_email, user_type FROM Users WHERE id=user_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2021-12-29 15:30:29
